...
export function ServerManagePage() {
  ...
  const handlePower = async (action: "start" | "stop" | "restart") => {
    ...
    try {
      const res = await csrfFetch(`/server/${id}/power/${action}`, {
        method: "POST",
      });
      if (!res.ok) {
  ...
  return (
    <div id="server-page-body" className="flex flex-col lg:flex-row px-8 mt-4">
      {/* Left side: Console */}
      ...
      <div className="w-full lg:w-1/3 mt-4 lg:mt-0 space-y-4 flex flex-col">
        {/* IP Address Card */}
        <div className="stats-card relative overflow-hidden bg-white dark:bg-neutral-800/50 backdrop-blur-sm border border-neutral-200 dark:border-neutral-700/30 rounded-xl px-4 py-4 shadow-sm hover:shadow-md transition-shadow duration-200 hover:bg-neutral-50 dark:hover:bg-neutral-700/30 group flex-1" style={{ "--i": 0 } as React.CSSProperties}>
        ...
        {/* Status Card */}
        <div className="stats-card relative overflow-hidden bg-white dark:bg-neutral-800/50 backdrop-blur-sm border border-neutral-200 dark:border-neutral-700/30 rounded-xl px-4 py-4 shadow-sm hover:shadow-md transition-shadow duration-200 hover:bg-neutral-50 dark:hover:bg-neutral-700/30 group flex-1" style={{ "--i": 1 } as React.CSSProperties}>
          <div className="pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-white/60 dark:via-white/10 to-transparent" />
        ...
        {/* RAM Usage Card */}
        <div className="stats-card relative overflow-hidden bg-white dark:bg-neutral-800/50 backdrop-blur-sm border border-neutral-200 dark:border-neutral-700/30 rounded-xl px-4 py-4 shadow-sm hover:shadow-md transition-shadow duration-200 hover:bg-neutral-50 dark:hover:bg-neutral-700/30 group flex-1" style={{ "--i": 2 } as React.CSSProperties}>
          <div className="pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-white/60 dark:via-white/10 to-transparent" />
        ...
        {/* CPU Usage Card */}
        <div className="stats-card relative overflow-hidden bg-white dark:bg-neutral-800/50 backdrop-blur-sm border border-neutral-200 dark:border-neutral-700/30 rounded-xl px-4 py-4 shadow-sm hover:shadow-md transition-shadow duration-200 hover:bg-neutral-50 dark:hover:bg-neutral-700/30 group flex-1" style={{ "--i": 3 } as React.CSSProperties}>
          <div className="pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-white/60 dark:via-white/10 to-transparent" />
          <div className="absolute inset-0 w-full h-full">
        ...
        {/* Disk Usage Card */}
        <div className="stats-card relative overflow-hidden bg-white dark:bg-neutral-800/50 backdrop-blur-sm border border-neutral-200 dark:border-neutral-700/30 rounded-xl px-4 py-4 shadow-sm hover:shadow-md transition-shadow duration-200 hover:bg-neutral-50 dark:hover:bg-neutral-700/30 group flex-1" style={{ "--i": 4 } as React.CSSProperties}>
          <div className="pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-white/60 dark:via-white/10 to-transparent" />
          <div className="relative z-10">
